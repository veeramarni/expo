 ...
 */
export declare function setNotificationIconAsync(
  icon: string | null,
  projectRoot: string
): Promise<void>;
export declare function setNotificationConfigAsync(
  props: {
    icon: string | null;
    color: string | null;
  },
...
export declare function setNotificationIconColorAsync(
  color: string | null,
  projectRoot: string
): Promise<void>;
/**
 ...
 */
export declare function setNotificationSoundsAsync(
  sounds: string[],
  projectRoot: string
): Promise<void>;
